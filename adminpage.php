...
if (isset($_POST['Submit'])) {
  ...
  $brandName=$_POST['brandName'];
	$query="SELECT * FROM `car` natural join `category` natural join `offices`";
  if($_POST['plateId'] != "nth")
  {
    $query .= " WHERE PlateId = '$plateId'";
  }else {
    $query .= "WHERE PlateId IS NOT NULL";
  }
...
$plateId_record=mysqli_query($conn, "select distinct  PlateId from `car`");
...
<body>
  ...
  <section class="home" id="home">
    <div class="arrange">
      <div class="text">
        <br><br><br><br><br><h1><span>Welcome!</span> <br>Explore Cars<br> </h1>
          ...
          <div class="arrange">
            ...
            <div class="checkbox-container">
              ...
              <div class="text">
				...
				<?php
				while ($data = mysqli_fetch_array($plateId_record)) {
				?>
				...
				?>
                  ...
                  <div class="text">
                  <select class="minimal" name="active" id="">
                  <option value="nth" >Car Status</option>
      ...
      <div class="services-container">
        ...
        ?>
          <div class="box">
            ...
            <h3>Plate Id: <?php echo $data['PlateId']; ?></h3>
            ...
            <h3>Car Status: <?php echo $data['CarStatus']; ?></h3>
            <h3>Number of seats: <?php echo $data['SeatingCapacity']; ?></h3>
            <a href="editCar.php?status=<?php echo $data['PlateId']; ?>" class="btn" >Edit</a>
          </div>
      <?php
        }
      }
